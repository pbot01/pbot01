  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Line BOT <sup></sup></div>
      </a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Search -->
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="GET" action="./tables.php" >
<!--             <div class="input-group"> -->
              <input type="date" class="form-control bg-light border-0 small" placeholder="Date..." aria-label="Search" id="date" name="date" aria-describedby="basic-addon2">
<!--               <div class="input-group-append">
              ...
              <input class="btn btn-primary" type="submit" name="search" value="serach">
<!--             </div> -->
          </form>
          <!-- Topbar Navbar -->
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Test_user</span>
                <img class="img-profile rounded-circle" src="https://slack-files2.s3-us-west-2.amazonaws.com/avatars/2017-05-03/178172234645_730ac1a261d34e4f358d_512.png">
              </a>
